...
path = '/home/neongreen13/Desktop/post_dpi/'
...
def get_folders():
    directory_list = list()
    for root, dirs, files in os.walk('/home/neongreen13/Desktop/post_dpi/', topdown=False):
        for name in dirs:
...
def folder_names():
    ...
    df['Match_Names'] = df.Match_Names.str.replace('/home/neongreen13/Desktop/post_dpi/','')
...
def timestamp_list():
    ...
    for folder,match in list(zip(directory_list,Match_List)):
        ...
        df.Image_Names = df.Image_Names.str.replace('/home/neongreen13/Desktop/post_dpi/','')
...
def augment_data():
    ...
    for folder,match in list(zip(directory_list,Match_List)):
        ...
        for pic, image in list(zip(bottom_score_list,image_list3)):
            ...
            cv2.imwrite(image_save_path + str(image),blur2)
...
def ocr_scoreboard_text():
    ...
    for folder in directory_list:
        ...
        df_topscore['Image'] = df_topscore.Image.str.replace('/home/neongreen13/Desktop/post_dpi/','')
        ...
        df_toppen['Image'] = df_toppen.Image.str.replace('/home/neongreen13/Desktop/post_dpi/','')
        ...
        df_bottomscore['Image'] = df_bottomscore.Image.str.replace('/home/neongreen13/Desktop/post_dpi/','')
        ...
        df_botpen['Image'] = df_botpen.Image.str.replace('/home/neongreen13/Desktop/post_dpi/','')
